...
These five priorities are the code-quality axis. Requirement fulfillment is a separate axis (see [requirements.md](requirements.md)).
...
4. **Anti-patterns** - Flag code smells that hurt readability or maintainability (see [smells.md](smells.md)).
