...
[`plugins/issue/evals/issue-refine/briefs`](../../../issue/evals/issue-refine/briefs) seeds its A/B scenarios
...
```bash
bun plugins/writing/evals/writing/scripts/mine.ts                      # writes data/samples.json
bun plugins/writing/evals/writing/scripts/mine.ts --limit 30
```
...
```bash
bun plugins/writing/evals/writing/label/server.ts                      # http://localhost:4320
```
