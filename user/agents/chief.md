...
hooks:
  SessionStart:
    - matcher: compact
      hooks:
        - type: command
          command: bun ~/.claude-repo/plugins/herdr/skills/herdr/scripts/ledger.ts status
---
...
```
bun ~/.claude-repo/plugins/herdr/skills/herdr/scripts/ledger.ts status
```
...
```
bun ~/.claude-repo/plugins/herdr/skills/herdr/scripts/board.ts --watch
```
