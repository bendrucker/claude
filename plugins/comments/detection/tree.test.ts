...
describe("scoreTree", () => {
  ...
  test("skips scratch directories and generated files", async () => {
    await write("tmp/throwaway.ts", heavy(20));
    await write("api.gen.ts", heavy(20));
    await write("machine.ts", `// @generated by a tool\n${heavy(20)}`);
