...
function judgeShard(shard) {
  const prompt = [
    ...
    'It contains { "id": <shard id>, "comments": [{ "id", "path", "language", "kind", "text", "context", "provenance"?, "doc"? }] }.',
    "provenance, when present, is the git blame of the comment's lines; the rubric says how to weigh it.",
    "doc, when present, marks the language's formal doc comment for a declaration or module; the rubric's Doc Comments section governs it.",
