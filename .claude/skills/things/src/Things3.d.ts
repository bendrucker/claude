...
export namespace Things3 {
  ...
  */
 export interface Area extends List {
   /**
  ...
  */
 export interface Contact extends List {}
 ...
 export interface ItemDetails {
   ...
   tagNames(): string;
    ...
    export interface GetLocalizedStringOptionalParameter {
      from: string;
    }
...
export interface Things3 extends Things3.Application {
    // Functions
     ...
     /**
      * Add a contact to Things
      * @param directParameter Name of the contact
      * @return New contact
      */
      ...
      * @return undefined
      */
     getLocalizedString(directParameter: {}, option?: Things3.GetLocalizedStringOptionalParameter): string;
}
