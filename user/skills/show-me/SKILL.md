...
When showing how existing code works, read it first and draw its real names. Follow a flow from where it enters, such as the route or command, to where the caller sees the result.
