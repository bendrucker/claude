---
name: wireframe
description: Create SVG wireframes for UI mockups with layout validation and PNG rendering. Use when creating wireframes, mockups, or skeletal UI layouts.
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- Mark image areas with "×" cross pattern
...
| `grid.svg` | 3×2 card grid with image placeholders |
