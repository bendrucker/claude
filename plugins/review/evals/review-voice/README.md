...
```bash
bun plugins/review/evals/review-voice/scripts/mine.ts            # -> data/candidates.json
bun plugins/review/evals/review-voice/label/server.ts            # browse http://localhost:4318
bun plugins/review/evals/review-voice/scripts/report.ts          # summary + full text of bad cases
```
