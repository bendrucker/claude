...
- Verify the code delivers on the linked ticket's acceptance criteria, not just that it compiles and passes tests (see [requirements.md](../requirements.md) for how to check fulfillment). Acceptance-criteria gaps are a blocking threshold here.
...
- See [tone.md](../tone.md) for comment style, including blocking vs non-blocking phrasing.
